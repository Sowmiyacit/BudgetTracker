    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100">
      ...
      <div className="w-full flex items-center justify-between px-8 py-4 bg-white shadow-sm mb-8">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-gray-700 text-lg">Register</span>
        </div>
        <button
      ...
      <div className="bg-white w-full max-w-md mx-auto rounded-2xl shadow-xl p-10">
        ...
        <div className="flex justify-between text-sm text-gray-500">
          <span className="cursor-pointer hover:underline" onClick={() => navigate('/login')}>Already have an account?</span>
          <span>
            <span>Login etc</span>
            <span
